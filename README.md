...
If you extract `analysis_outputs.zip`, you can view some of the results generated by **`codes.py`. These results show the analysis performed on a single image.

The results generated by **`smallcopycat.py` were too large to upload to GitHub because the script analyzed 200 images and also saved results for 20 example images. However, one example result is included below for reference.
